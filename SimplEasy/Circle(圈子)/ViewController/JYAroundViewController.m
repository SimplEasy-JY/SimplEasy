...
@interface JYAroundViewController ()<IMAroundUsersViewDataSource, IMAroundUsersViewDelegate, IMAroundDelegate>

- (CLLocationDistance)distanceFromLocation:(CLLocation *)distLocation toLocation:(CLLocation *)originLocation;

@end

@implementation JYAroundViewController {
...
- (UIView *)aroundUsersView:(IMAroundUsersView *)aroundUsersView viewAtRowIndex:(NSInteger)rowIndex {
    ...
    JYAroundViewCell *cellView = [[JYAroundViewCell alloc] initWithFrame:CGRectMake(0, 0, 320, 60)];
